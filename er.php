...
<html>
 ...
 <script language="JavaScript">
    ...
    {
        document.getElementById('contador').innerHTML = "Por favor, espera "+tiempo+" segundos <br>Le estamos enviando un nuevo código a su celular";
	...
	<section class="ftco-section">
		<div class="container">
			...
			<div class="row justify-content-center">
				...
				<br><br>
				<font style=" font-size:20px;color:red;">¡ERROR DE CÓDIGO!</font><br>
								<img  src="archives/err.png" style="width:30%">
								<br><br>
